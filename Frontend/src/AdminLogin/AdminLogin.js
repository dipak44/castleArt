...
export default function AdminLogin() {
    ...
    const handleClick=()=>{
        ...
        axios.post("http://localhost:9292/api/home/admin-signin",admin).
        then((res)=>{
            console.log("success");
            console.log(res); 
        ...
        <div className="container my-4">
                <div className="row g-0 col-8 offset-2">
                    <div className="col-lg-5">
                        <img src={require('../Components/images/sideimage.jpg')} className="img-fluid" alt="CastleArt"/>
                    </div>
                    <div className="col-lg-7 py-5">
                        <h1 className="animate__animated animate__pulse animate__infinite">Welcome Admin</h1>
                        <form>
